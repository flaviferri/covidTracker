...
const SymptomSection = () => {
  return (
      ...
      <div className="symptom-cards">
        ...
        <SymptomCard
          icon="/src/assets/images/banner-right-removebg-preview.png"
        ...
        />
        <SymptomCard
          icon="/src/assets/images/cough-removebg-preview.png"
          title="Runny nose"
          description="People of all ages who experience fever and/or  cough associated withdifficulty breathing/shortness of breath."
        />
        <SymptomCard
          icon="/src/assets/images/breathing-removebg-preview.png"
          title="Sore throat"
